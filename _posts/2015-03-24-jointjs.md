...
And finally, the implementation of JointJS. The documentation is really helpful, but all of the sizing and spacing had to be done manually. I heard that the spacing is done for you if you're using d3, so that's something useful to look into for next time.

Hopefully the comments I added in are clear enough, but if you have any questions, feel free to reach out to me!
